{
    logdir: "/datadrive2/bert_run_11",
    model_config: "configs/spider-20190205/nl2code-1017-bert.jsonnet",
    model_config_args: {
        bs: 8,
    ...
    eval_name: "bert_run6_%s_%d" % [self.eval_use_heuristic, self.eval_beam_size],
    eval_output: "ie_dirs",
    eval_beam_size: 1,
