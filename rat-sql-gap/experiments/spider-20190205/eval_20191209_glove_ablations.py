'''
python experiments/spider-20190205/eval_20191209_glove_ablations.py \
    --philly-yaml /mnt/wuphillyblob_share/spider/spider-1209-ablations-att0to4/philly.yaml \
    --blob-root /mnt/wuphillyblob_blob \
    --output /mnt/wuphillyblob_share/spider/spider-1209-ablations-att0to4/results \
    > eval_20191209_ablations.txt
'''
import codecs
import json
import re
